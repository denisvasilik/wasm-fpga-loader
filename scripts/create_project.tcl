...
set obj [get_filesets sources_1]
set_property -name "top" -value "WasmFpgaLoader" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
set_property -name "top_file" -value "${project_src}/WasmFpgaLoader.vhd" -objects $obj
...
set obj [get_filesets sim_1]
set_property "top" "tb_WasmFpgaLoader" $obj
